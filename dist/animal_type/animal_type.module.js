...
exports.AnimalTypeModule = AnimalTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: animal_type_schema_1.AnimalType.name,
                    schema: animal_type_schema_1.AnimalTypeSchema,
                },
            ]),
            jwt_1.JwtModule.register({}),
        ],
        controllers: [animal_type_controller_1.AnimalTypeController],
        providers: [animal_type_service_1.AnimalTypeService],
    })
], AnimalTypeModule);
