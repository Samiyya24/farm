    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: worker_schemas_1.Worker.name,
                    schema: worker_schemas_1.WorkerSchema,
                },
                {
                    name: speciality_schema_1.Speciality.name,
                    schema: speciality_schema_1.SpecialitySchema,
                },
            ]),
        ],
