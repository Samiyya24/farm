...
let MilkProductionModule = class MilkProductionModule {
};
exports.MilkProductionModule = MilkProductionModule;
exports.MilkProductionModule = MilkProductionModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: milk_production_schema_1.MilkProduction.name,
                    schema: milk_production_schema_1.MilkProductionSchema,
                },
            ]),
